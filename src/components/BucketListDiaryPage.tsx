          ...
          <div className="bg-white/95 rounded-2xl p-4 border border-purple-200/80 shadow-xs space-y-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-pink-600 hover:bg-pink-700 disabled:opacity-40 text-white text-xs font-semibold shadow-xs flex items-center gap-1 cursor-pointer transition-all"
              >
                <Plus className="w-3.5 h-3.5 text-pink-200" />
                <span>Add</span>
              </button>
            </div>
          </div>
